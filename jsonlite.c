...
PHP_MINIT_FUNCTION (jsonlite) {
    ...
    */
    ...
    REGISTER_LONG_CONSTANT("JSONLITE_MODE_MIN", JSONLITE_MODE_MIN, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("JSONLITE_MODE_JS", JSONLITE_MODE_JS, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("JSONLITE_MODE_STRICT", JSONLITE_MODE_STRICT, CONST_CS | CONST_PERSISTENT);
    return SUCCESS;
}
/* }}} */
